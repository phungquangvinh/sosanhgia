...
//    public $use_collection = false;


    public function info()
    {
        return $this->hasOne('info', UserInfo::class, 'user_id');
    }

    public function news()
    {
        return $this->hasMany('news', News::class, 'user_id');
    }
    ...
    public function getByEmail($email, $fields = "*")
    {
        ...
        return $this->query->select('use_email = \'' . $email . '\'');
    }
    ...
    {
        return $this->query->where("use_id = " . (int)$id)->select();
    }
     ...
     * @return bool
     */
    public function createUserFromDataIdVg($info)
    {
        ...
        $myfrom->add('use_yahoo', 'use_yahoo', 0, 1, $use_yahoo, 0, 'use_yahoo');
    ...
    /**
     * Cập nhật thông tin user từ
     * @param  array $info
     * @param  string $email
     * @return void
     */
    public function update_info_from_email($info, $email)
    {
        # code...
    }
