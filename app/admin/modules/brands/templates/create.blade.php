                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group col-sm-12 {{bts_er($errors, 'bra_name')}}">
                                    ...
                                    <input type="text" class="form-control" name="bra_name" value="{{ array_get($oldInputs, 'bra_name') }}">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group col-sm-12 {{ bts_er($errors, 'bra_content') }}">
                                    ...
                                    <textarea class="form-control" name="bra_content" rows="5">{{ array_get($oldInputs, 'bra_content') }}</textarea>
