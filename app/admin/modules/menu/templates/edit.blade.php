                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group col-sm-12 {{bts_er($errors, 'menu_name')}}">
                                    ...
                                    <input type="text" class="form-control" id="menu_name" name="menu_name" value="{{$updateListMenu->menu_name}}">
                                ...
                                <div class="form-group col-sm-12 {{bts_er($errors, 'menu_description')}}">
                                    ...
                                    <input type="text" class="form-control" name="menu_description" value="{{$updateListMenu->menu_description}}">
                                ...
                                <div class="form-group col-sm-12 {{bts_er($errors, 'menu_link')}}">
                                    ...
                                    <input type="text" class="form-control" id="menu_link" name="menu_link" value="{{$updateListMenu->menu_link}}">
                            ...
                            <div class="col-sm-6">
                                    ...
                                    <select class="form-control" id="menu_category" name="menu_category">
                                        @foreach($category as $category)
                                            @if($category->cat_has_child == 1)
                                                <option style="font-weight: bold;" value="{{$category->cat_id}}"
                                                    @if($updateListMenu->menu_category_id == $category->cat_id)
                                                        {{"selected"}}
                                ...
                                <div class="col-sm-12 img-css {{bts_er($errors, 'menu_icon')}}">
                                    <label for="name" style="font-size: 14px;">Icon <b id="bt_red">( * )</b></label>
                                    <input id="picture" type="file" value="{{ array_get($oldInputs, 'menu_icon') }}" name="menu_icon" class="form-control">
                                    <div id="show-img">
                                        <img src="{{$updateListMenu->getImgMenu()}}" alt="" id="show_photo" style="margin-top:10px">
                                    </div>
