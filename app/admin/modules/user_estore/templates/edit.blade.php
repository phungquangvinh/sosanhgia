                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                <div class="form-group col-sm-12 {{bts_er($errors, 'ue_name')}}">
                                    ...
                                    <input type="text" class="form-control" name="ue_name" value="{{$updateUserEstore->ue_name}}">
                                ...
                                <div class="form-group col-sm-12 {{bts_er($errors, 'ue_link')}}">
                                    ...
                                    <input type="text" class="form-control" name="ue_link" value="{{$updateUserEstore->ue_link}}">
                                ...
                                <div class="col-sm-12 img-css {{bts_er($errors, 'ue_image')}}">
                                    ...
                                    <div id="show-img">
                                        <img src="{{$updateUserEstore->getImgUserEstore()}}" alt="" width="250px" id="show_photo" style="margin-top:10px">
                                    </div>
