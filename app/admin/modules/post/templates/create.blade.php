    ...
    <div class="panel panel-default" style="margin-left: 10px;margin-right: 10px">
        ...
        <div class="panel-body">
            <form action="" method="POST" role="form" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                <div class="form-group col-sm-12 {{bts_er($errors, 'pos_title')}}">
                                    ...
                                    <input type="text" class="form-control" name="pos_title" value="{{ array_get($oldInputs, 'pos_title') }}">
                                ...
                                <div class="form-group col-sm-12 {{ bts_er($errors, 'pos_teaser') }}">
                                    ...
                                    <textarea class="form-control post_content" name="pos_teaser" rows="10">{{ array_get($oldInputs, 'pos_teaser') }}</textarea>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-group col-sm-12 {{bts_er($errors, 'pos_active')}}">
                                    ...
                                    <input type="radio" name="pos_active" value="1" checked><span style="color: green">Activated</span>
                                    <input type="radio" name="pos_active" value="0"><span style="color: red">Deactivated</span>
                                </div>

                                <div class="col-sm-12 img-css {{bts_er($errors, 'pos_image')}}">
                                    <label for="name" style="font-size: 14px;">Ảnh đại diện</label>
                ...
                <!-- <input type="text" value="{{ $_SESSION['adm_id'] }}" name="pos_admin_id"> -->
                <input type="hidden" name="action" value="add">
                <div class="form-group col-sm-12">
                    <button type="submit" class="btn btn-md btn-primary">Thêm tin tức</button>
                </div>
            </form>
        </div>
    </div>
