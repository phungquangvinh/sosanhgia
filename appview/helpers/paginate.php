...
if(! function_exists('showPaginate'))
{
    ...
    function showPaginate($perPage, $currentPage, $total, $append = array())
    {
        ...
        if($lastPage > 1)
        {
            ...
            {
                $pagination.= "<li><a href='".appendUrl($append, ['page' => $next])."'>&rsaquo;</a></li>";
                $pagination.= "<li><a href='".appendUrl($append, ['page' => $lastPage])."'>&rsaquo;&rsaquo;</a></li>";
            }else
            {
                $pagination.= "<li><a class='current'>&rsaquo;</a></li>";
                $pagination.= "<li><a class='current'>&rsaquo;&rsaquo;</a></li>";
            }
